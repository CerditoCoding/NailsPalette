...
export default async function NewProductPage() {
  ...
  return (
    <div>
      ...
      {(collections.length === 0 || shapes.length === 0 || sizes.length === 0 || designs.length === 0) && (
        <p className="mb-4 rounded-lg bg-amber-50 px-4 py-3 text-sm text-amber-700">
          Necesitás al menos una colección, una forma, un talle y un nivel de diseño creados en{" "}
      ...
      <ProductForm tags={{ collections, shapes, sizes, designs }} />
    </div>
  );
}
