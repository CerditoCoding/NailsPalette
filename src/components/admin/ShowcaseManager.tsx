...
export function ShowcaseManager({ initialPhotos }: { initialPhotos: Photo[] }) {
    ...
    <div>
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
        {photos.map((photo) => (
          <div
            key={photo.id}
            className="relative aspect-video overflow-hidden rounded-xl border border-pink-100"
          >
        ...
        {photos.length < MAX_PHOTOS && (
          <label className="flex aspect-video cursor-pointer flex-col items-center justify-center gap-1 rounded-xl border border-dashed border-pink-300 text-center text-sm text-pink-500 hover:bg-pink-50">
